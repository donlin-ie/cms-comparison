...
class CustomNavbar extends React.Component {
  componentDidMount() {
    ...
    if (this.isSlide()) {
      const slideSelected = this.props.pageInfo.slideIndex
        ? this.props.pageInfo.slideIndex
        : null
              ...
              {this.isSlide() ? (
                <ButtonToolbar>
                  {this.hasPreviousSlide() ? (
                    <Button href={this.getPreviousSlideUrl()}> &lt; </Button>
                  ) : null}
                  {this.hasNextSlide() ? (
                    <Button href={this.getNextSlideUrl()}>Next</Button>
                  ) : null}
                </ButtonToolbar>
              ) : null}
            </Nav>
